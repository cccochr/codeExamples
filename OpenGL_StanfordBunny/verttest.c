...
for(i=0;i<3;i++) glVertex3f(f1[i].x,f1[i].y,f1[i].z);
glNormal3f(0.0,0.0,1.0);
for(i=0;i<3;i++) glVertex3f(f2[i].x,f2[i].y,f2[i].z);
glNormal3f(0.0,0.0,1.0);
for(i=0;i<3;i++) glVertex3f(f3[i].x,f3[i].y,f3[i].z);
glNormal3f(0.0,0.0,1.0);
for(i=0;i<3;i++) glVertex3f(f4[i].x,f4[i].y,f4[i].z);
glEnd();
glutSwapBuffers();
